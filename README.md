...
| `configService.labels` | Extra labels definition of apollo-configservice | `{}` |
...
| `adminService.labels` | Extra labels definition of apollo-adminservice | `{}` |
...
| `labels` | Extra labels definition of apollo-portal | `{}` |
